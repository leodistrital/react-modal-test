...
// import './css/DialogDemo.css'
// import "primereact/resources/themes/bootstrap4-light-blue/theme.css";  //theme
// import "primereact/resources/primereact.min.css";                  //core css
// import "primeicons/primeicons.css";                                //icons
 
import imagquipo from './images/equipo/javier_cancela.jpg'
// import imagquipo from '../images/'
...
function App() {
  ...
  return (
    ...
    <h1 onClick={()=>{habldeventana()}} >abrrir</h1>
    <br/>
    <br/>
    <br/>
    <br/>
    <br/>
      ...
      <Modal isOpen={ventana}>
        <p  onClick={()=>{habldeventana()}} >This is Modal content</p>
